...
class Sample01Spec extends FeatureSpec {
  ...
  feature("Sample01 files should be read correctly") {
    ...
    scenario("Eb015pi.c3d") {
      ...
      val readXML = c3d2xmlString(fetchC3DFile("sample01/Eb015pi.c3d"))
    ...
    scenario("Eb015pr.c3d") {
      ...
      val readXML = c3d2xmlString(fetchC3DFile("sample01/Eb015pr.c3d"))
      val diff = new Diff(refXML, readXML)
      assert(diff.similar())
    }
    ...
    scenario("Eb015si.c3d") {
      ...
      val readXML = c3d2xmlString(fetchC3DFile("sample01/Eb015si.c3d"))
      val diff = new Diff(refXML, readXML)
      assert(diff.similar())
    }
    ...
    scenario("Eb015sr.c3d") {
      ...
      val readXML = c3d2xmlString(fetchC3DFile("sample01/Eb015sr.c3d"))
      val diff = new Diff(refXML, readXML)
      assert(diff.similar())
    }
    ...
    scenario("Eb015vi.c3d") {
      ...
      val readXML = c3d2xmlString(fetchC3DFile("sample01/Eb015vi.c3d"))
      val diff = new Diff(refXML, readXML)
      assert(diff.similar())
    }
    ...
    scenario("Eb015vr.c3d") {
      ...
      val readXML = c3d2xmlString(fetchC3DFile("sample01/Eb015vr.c3d"))
      val diff = new Diff(refXML, readXML)
      assert(diff.similar())
    }
